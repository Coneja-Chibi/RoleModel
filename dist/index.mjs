...
function getTierLabel(tier) {
  switch (tier) {
    ...
    case "small":
      return "Small (8K-32K)";
    case "medium":
      return "Medium (32K-128K)";
    case "large":
      return "Large (128K-500K)";
    case "massive":
      return "Massive (500K+)";
  }
}
...
function getBudgetStatus(tokens, contextLimit) {
...
function isOverBudget(tokens, model) {
...
export { FALLBACK_MODELS, KNOWN_PROVIDERS, MODEL_COLORS, MODEL_ICONS, UNKNOWN_PROVIDER, buildRegistry, fetchFromOpenRouter, fetchRegistry, fetchRegistryWithFallback, findModel, formatContextLength, formatModelPricing, formatPrice, getBudgetStatus, getContextLimit, getFallbackRegistry, getModelColor, getModelIcon, getProviders, getStats, getTierEmoji, getTierLabel, isOverBudget, loadFromSnapshot, queryModels, transformModel, transformModels };
